...
| Metric                           | Count |
|----------------------------------|-------|
| Issues committed at sprint start |   10  |
| Issues completed                 |   1   |
| Issues not completed             |   9   |
...
| Total story points completed     |   1   |
| Completion %                     |  5.2% |
...
Issue: Add multiplayer capabilities (2 player for now) -> To Do 
(This will be attempted in the next sprint as a requirement for my Cloud Computing class)
(Other updates/issues in the board come after this, since it's highest priority)
